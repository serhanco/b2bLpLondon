...
<main>
    ...
    <div class="wrap">
      ...
      <div class="lead-card" id="enquiry">
        <form id="leadForm" novalidate>
          ...
          <p class="fhint">Provide your details to discuss partnership opportunities, refer a patient or book a meeting at our Istanbul Headquarters.</p>
        ...
        <div class="form-msg" id="formSuccess">
          ...
          <p>Our Global partnership team will review your details and get back to you shortly.</p>
        </div>
  ...
  <div class="ribbon">
    <div class="wrap">
      ...
      <div class="item"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><circle cx="12" cy="11" r="3"/></svg> Global Operations Hub</div>
    </div>
  </div>
    ...
    <div class="wrap">
      ...
      <div class="pathways">
        ...
        <div class="path">
          ...
          <p>From the moment they leave their home country until they return, your patients are in safe hands.</p>
          <ul class="check-list" style="margin-top:20px">
  ...
  <section style="background:var(--bg-soft);border-top:1px solid var(--line);border-bottom:1px solid var(--line)">
    <div class="wrap">
      ...
      <div class="timeline">
        <div class="t-item"><div class="num">1</div><h3>Submit Case</h3><p>Share the patient's medical summary securely with our Global team.</p></div>
  ...
  <section>
    <div class="wrap">
      ...
      <div class="value">
        ...
        <div class="vcard"><div class="vic"><svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><circle cx="12" cy="11" r="3"/></svg></div><h3>Istanbul Headquarters</h3><p>Face-to-face meetings at our Istanbul Headquarters.</p></div>
      </div>
    </div>
  </section>
    ...
    <div class="wrap">
      ...
      <div class="faq">
        <details>
          ...
          <div class="ans">Whether you are a physician, clinic manager, medical facilitator, business owner, or entrepreneur anywhere in the world, you can seamlessly refer complex cases to our specialists. We provide an expert medical review and a comprehensive treatment plan to support your clients and patients.</div>
        </details>
        <details>
        ...
        <details>
          ...
          <div class="ans">No, becoming a referring partner is completely free. We invest in our partnership by providing a dedicated global coordination team, fast MDT evaluations, and continuous clinical support.</div>
        </details>
        <details>
